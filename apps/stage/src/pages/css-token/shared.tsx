...
const CSS_VAR_BY_PATH: Record<string, string> = {
  ...
  'colors.semantic.translucent.brandBlue.a10': '--fd-color-translucent-brand-blue-a10',
  'colors.semantic.translucent.brandBlue.a30': '--fd-color-translucent-brand-blue-a30',
  'colors.semantic.translucent.brandBlue.a50': '--fd-color-translucent-brand-blue-a50',
  'colors.semantic.translucent.brandBlue.a70': '--fd-color-translucent-brand-blue-a70',
  'colors.semantic.translucent.brandPink.a10': '--fd-color-translucent-brand-pink-a10',
  'colors.semantic.translucent.brandPink.a30': '--fd-color-translucent-brand-pink-a30',
  'colors.semantic.translucent.brandPink.a50': '--fd-color-translucent-brand-pink-a50',
  'colors.semantic.translucent.brandPink.a70': '--fd-color-translucent-brand-pink-a70',
  'colors.semantic.translucent.functionalRed.a10': '--fd-color-translucent-functional-red-a10',
  'colors.semantic.translucent.functionalRed.a30': '--fd-color-translucent-functional-red-a30',
  'colors.semantic.translucent.functionalRed.a50': '--fd-color-translucent-functional-red-a50',
  'colors.semantic.translucent.functionalRed.a70': '--fd-color-translucent-functional-red-a70',
  'colors.semantic.translucent.functionalOrange.a10': '--fd-color-translucent-functional-orange-a10',
  'colors.semantic.translucent.functionalOrange.a30': '--fd-color-translucent-functional-orange-a30',
  'colors.semantic.translucent.functionalOrange.a50': '--fd-color-translucent-functional-orange-a50',
  'colors.semantic.translucent.functionalOrange.a70': '--fd-color-translucent-functional-orange-a70',
  'colors.semantic.translucent.functionalGreen.a10': '--fd-color-translucent-functional-green-a10',
  'colors.semantic.translucent.functionalGreen.a30': '--fd-color-translucent-functional-green-a30',
  'colors.semantic.translucent.functionalGreen.a50': '--fd-color-translucent-functional-green-a50',
  'colors.semantic.translucent.functionalGreen.a70': '--fd-color-translucent-functional-green-a70',
  'colors.semantic.translucent.neutralGray.a60': '--fd-color-translucent-neutral-gray-a60',
  'colors.semantic.translucent.neutralGray.a40': '--fd-color-translucent-neutral-gray-a40',
  'colors.semantic.translucent.neutralGray.a20': '--fd-color-translucent-neutral-gray-a20',
