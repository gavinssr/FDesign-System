...
export const typographyStyles = {
  ...
  body12SingleLine: {
    fontFamily: fontFamilies.semantic.textChinese,
    fontSize: fontSize.base,
    lineHeight: lineHeight.singleLine.base,
    fontWeight: fontWeight.regular,
  },
  body12SingleLineStrong: {
    fontFamily: fontFamilies.semantic.textChinese,
    fontSize: fontSize.base,
    lineHeight: lineHeight.singleLine.base,
    fontWeight: fontWeight.medium,
  ...
  displayNumber20Medium: {
    fontFamily: fontFamilies.semantic.displayLatin,
    fontSize: fontSize.displayMicro,
    lineHeight: lineHeight.singleLine.displayMicro,
    fontWeight: fontWeight.medium,
  },
  displayNumber18Medium: {
    fontFamily: fontFamilies.semantic.displayLatin,
    fontSize: fontSize.head,
    lineHeight: lineHeight.singleLine.head,
    fontWeight: fontWeight.medium,
  },
  displayNumber16Medium: {
    fontFamily: fontFamilies.semantic.displayLatin,
    fontSize: fontSize.increase,
    lineHeight: lineHeight.singleLine.increase,
    fontWeight: fontWeight.medium,
  },
  displayNumber14Medium: {
    fontFamily: fontFamilies.semantic.displayLatin,
    fontSize: fontSize.further,
    lineHeight: lineHeight.singleLine.further,
    fontWeight: fontWeight.medium,
